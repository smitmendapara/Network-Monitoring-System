...
<%@ taglib uri="/struts-tags" prefix="s" %>
    ...
    <script deviceType="text/javascript" src="js/jquery-3.1.1.min.js"></script>
    ...
    <br/>
        ...
        <div class="demo" style="float:left;margin-top: 10px">
            ...
            <nav>
                ...
                <i class="bi bi-search" style="margin-left:1040px;"></i><input deviceType="text" class="monitor__search" placeholder="search here" style="height:25px;border-radius:10px;margin-left:6px;">
