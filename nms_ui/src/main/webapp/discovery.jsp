...
<%@ taglib uri="/struts-tags" prefix="s" %>
    ...
    <div class="demo" style="margin-top: 10px">
        ...
        <nav>
            ...
            <button type="button" class="disc__new middle" id="new" onclick="openForm('discoveryForm')" style="margin-left: 1043px;cursor: pointer"><i class="bi bi-cloud-plus"></i>&nbsp;new</button>
    ...
    <div class="demo" id="myTableDiv" style="display: none">
            ...
            %>
                            <tr class="disc__data"  id="<%=id %>">
                                ...
                                <td class="disc__icon">
                                    ...
                                    <%--id="<%=resultSet.getString(1) %>" this.id--%>

                                    <button name ='btn1' deviceType="submit" onclick="showForm('provisionForm', '<%=id %>')" ><i class="bi bi-eye disc__monitor" title="View Result"></i></button> &nbsp;
    ...
    <div class="disc__popUp" id="provisionForm" style="display: none">
