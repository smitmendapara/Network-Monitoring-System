...
<%@ taglib uri="/struts-tags" prefix="s" %>
    ...
    <h3 class="middle" style="margin-left:1250px;">Create IP</h3>
    ...
    <div class="demo">
        ...
        <nav>
            ...
            <button type="button" class="disc__new middle" onclick="openForm('discoveryForm')" style="margin-left: 1100px;cursor: pointer">new</button>

            <%--<a href="" class="disc__new middle" onclick="openForm('discoveryForm')"  style="margin-left:1100px;">new</a>--%>
