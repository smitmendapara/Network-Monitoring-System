            ...
            %>
                            <tr class="disc__data"  id="<%=id %>">
                                ...
                                <td class="disc__icon">
                                    ...
                                    <button name ='btn1' type="submit" onclick="showForm('provisionForm', '<%=id %>')" ><i class="bi bi-tv disc__monitor" title="View Result"></i></button> &nbsp;
    ...
    <div class="disc__popUp" id="provisionForm">
        ...
        <form action="" class="disc__container" method="POST">
            ...
            <div class="popUp__footer" style="margin: 1px 3px 0 530px;">
                ...
                <button type="button" class="btn footer__provision" onclick="monitorData()" style="cursor: pointer">Provision Object</button>
