...
//        System.out.println(Runtime.getRuntime().availableProcessors());
        ...
        SSHConnectionUtil sshObject = SSHConnectionUtil.getSSHObject("172.16.10.88", CommonConstant.SSH_PORT, "root", "motadata", 10);
//
...
//
//        System.out.println(discoveryService.executeDeviceDiscovery(1, "172.16.8.182", "", "", "Ping"));
