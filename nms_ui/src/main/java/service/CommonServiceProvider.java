            ...
            if (deviceType.equals(CommonConstantUI.STRING_ONE) || deviceType.equals(CommonConstantUI.LINUX_DEVICE))
            {
                ...
                try
                {
                    ...
                    if (ipStatus.equals(CommonConstantUI.DEVICE_UP))
                    {
                        ...
                        {
                            uName = sshConnectionUtil.executeCommand(CommonConstantUI.U_NAME_COMMAND);
                ...
                try
                {
                    ...
                    if (ipStatus.equals(CommonConstantUI.DEVICE_UP))
                    {
                        ...
                        if(sshConnectionUtil != null)
                        {
                            ...
                            uName_M = sshConnectionUtil.executeCommand(CommonConstantUI.NAME_M_COMMAND);

                            uName_R = sshConnectionUtil.executeCommand(CommonConstantUI.NAME_R_COMMAND);

                            hostName = sshConnectionUtil.executeCommand(CommonConstantUI.HOSTNAME_COMMAND);

                            uName_Output = sshConnectionUtil.executeCommand(CommonConstantUI.LINUX_U_NAME_COMMAND);

                            free_Output = sshConnectionUtil.executeCommand(CommonConstantUI.LINUX_FREE_COMMAND);

                            df_Output = sshConnectionUtil.executeCommand(CommonConstantUI.LINUX_DISK_COMMAND);

                            ioStat_Output = sshConnectionUtil.executeCommand(CommonConstantUI.LINUX_CPU_COMMAND);
