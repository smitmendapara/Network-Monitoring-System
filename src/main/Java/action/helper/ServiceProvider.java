...
public class ServiceProvider
{
    ...
    private static String top_Output = null;
            ...
            if (deviceType.equals("1") || deviceType.equals("Linux"))
            {
                ...
                try
                {
                    ...
                    if(sshConnectionUtil != null)
                    {
                        ...
                        top_Output = sshConnectionUtil.executeCommand("top -H");
                        ...
                        specificData = getSpecificData(uName_Output, free_Output, df_Output, top_Output, ioStat_Output);
    ...
    private static String getSpecificData(String uName_output, String free_output, String df_Output, String top_Output, String ioStat_Output)
    {
        String data = null;
        ...
        try
        {
            ...
            String CPU = dfSplit[8].substring(42, 46).trim();
            ...
            String []stringArray = {linux, ubuntu, x86, totalMemory, usedMemory, freeMemory, osVersion, osName, totalSwap, usedSwap, freeSwap};
