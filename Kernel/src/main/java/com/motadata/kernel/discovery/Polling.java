...
//        try
//        {
//            ip = CommonUtil.takePollingIp();
//
//            deviceType = CommonUtil.takeDeviceType();
//
...
//
//                    resultSet = DataAccess.getReMonitorData(ip, deviceType);
//
...
//                try
//                {
//                    ResultSet resultSet = DataAccess.getReMonitorData(ip, deviceType);
//
//                    boolean next = resultSet.next();
//
//                    if (next)
